...
from Services import addDatasServices
from Services import editDatasServices
from Services import confirmChanges
...
class ServicesWindow(QWidget):
    def __init__(self, stacked_widget):
        ...
        # Set the window size
        self.setWindowTitle('Салон 3красоты')
        ...
        self.master_label = QLabel('Выберите услугу:')
        self.master_label.setFixedWidth(150)
        self.master_combobox = QComboBox()
        self.master_combobox.addItems(['Услуга 1', 'Услуга 2', 'Услуга 3', 'Услуга 4'])
        ...
        self.table.setHorizontalHeaderLabels(['Название', 'Цена', 'Длительность'])
    ...
    def open_add_window(self):
        ...
        add_window = addDatasServices.AddDataForm(self.stacked_widget)  # Создайте объект из вашего окна добавления данных
    ...
    def open_edit_window(self):
        ...
        edit_window = editDatasServices.EditDataForm(self.stacked_widget)  # Создайте объект из вашего окна редактирования
