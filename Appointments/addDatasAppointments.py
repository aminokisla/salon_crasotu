...
class AddDataForm(QWidget):
    def __init__(self,stacked_widget):
        ...
        # Заголовок формы
        title_label = QLabel('Добавление данных')
        title_label.setStyleSheet("font-size: 23px; font-weight: bold;")
        title_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        main_layout.addWidget(title_label)
        main_layout.addSpacing(40)

        # Список меток и полей ввода
        labels = ['ФИО клиента', 'Услуга', 'Мастер', 'Дата', 'Время']
