...
from Masters import confirmChanges
from Masters import editDatasMasters
from Masters import addDatasMasters
...
class MastersWindow(QWidget):
    ...
    def open_add_window(self):
        ...
        add_window = addDatasMasters.AddDataForm(self.stacked_widget)  # Создайте объект из вашего окна добавления данных
    ...
    def open_edit_window(self):
        ...
        edit_window = editDatasMasters.EditDataForm(self.stacked_widget)  # Создайте объект из вашего окна редактирования
